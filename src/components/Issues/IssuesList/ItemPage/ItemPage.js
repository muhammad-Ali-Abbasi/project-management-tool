    ...
    <Card className={classes.root}>
        <CardContent>
          <Typography  component="h2" variant="h2" color="primary" gutterBottom>
            Name:{item.issueName?item.issueName:"Empty"}
          </Typography>
          <br/>
        ...
        <CardActions>
          ...
          <Button size="small"  onClick={()=>{props.deleteissue(item.id); history.push("/IssuesList")}} color="secondary" variant="contained">Delete</Button>
        </CardActions>
      </Card>
    </Container>
